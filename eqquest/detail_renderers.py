...
_KIND_FIELDS: dict[str, tuple[tuple[str, tuple[str, ...]], ...]] = {
    ...
    "combat_ability": (
        ("Combat ability ID", ("abilityId", "ability_id", "id")),
        ("Spell ID", ("spellId", "spell_id")),
        ("Spell name", ("spellName", "spell_name")),
        ("Skill", ("skill", "skillName", "skill_name")),
        ("Classes", ("classes", "class", "className", "class_name")),
        ("Level", ("level", "requiredLevel", "required_level")),
        ("Endurance", ("endurance", "enduranceCost", "endurance_cost")),
        ("Mana", ("mana", "manaCost", "mana_cost")),
        ("Cast time", ("castTime", "cast_time")),
        ("Recovery", ("recoveryTime", "recovery_time")),
        ("Recast", ("recastTime", "recast_time", "reuse", "reuseTime", "reuse_time")),
        ("Duration", ("duration", "durationValue", "duration_value")),
        ("Range", ("range",)),
        ("AE range", ("aeRange", "ae_range")),
        ("Target", ("target", "targetType", "target_type")),
        ("Resist", ("resist", "resistType", "resist_type")),
        ("Category", ("category", "categoryName", "category_name")),
        ("Effects", ("effects", "effectSlots", "effect_slots")),
        ("Identity join", ("identityJoin", "identity_join")),
    ),
}
