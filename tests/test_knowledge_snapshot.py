...
class KnowledgeSnapshotTests(unittest.TestCase):
    ...
    def _populate_working_db(self) -> None:
        ...
        try:
            ...
            db.set_meta("approved_travel_supplement_count", "3")
            db.set_meta("approved_travel_supplement_edge_count", "22")
    ...
    def test_snapshot_is_a_copy_and_strips_runtime_state(self):
        ...
        try:
            ...
            self.assertEqual(meta["approved_travel_supplement_count"], "3")
            self.assertEqual(meta["approved_travel_supplement_edge_count"], "22")
