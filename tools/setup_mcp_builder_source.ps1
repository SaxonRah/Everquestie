...
Write-Host "EverQuestie MCP builder source setup"
...
# submodule. Git checkouts and downloaded source ZIPs therefore use the same layout;
...
Write-Host "Installing/building everquest1-mcp builder source..."
...
Write-Host ""
Write-Host "everquest1-mcp builder source is ready."
