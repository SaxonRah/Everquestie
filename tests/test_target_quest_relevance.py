...
class TargetQuestRelevanceTests(unittest.TestCase):
    ...
    def test_direct_source_backed_quest_relationship_is_actionable_relevance(self):
        npc = self._npc()
    ...
    def test_unprovenanced_direct_relationship_is_rejected(self):
        ...
        self.db.upsert_relationship(
            ...
            "objective_kill",
            source_page_id=None,
            evidence="Unreviewed relationship.",
        )
